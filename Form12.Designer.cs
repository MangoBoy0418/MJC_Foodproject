namespace MJC_Foodproject
{
    partial class Form12
    {
        ...
        private void InitializeComponent()
        {
            ...
            button3.Location = new Point(4, 255);
            button3.Margin = new Padding(4, 5, 4, 5);
            button3.Name = "button3";
            button3.Size = new Size(754, 115);
            button3.TabIndex = 2;
            button3.Text = "치킨";
            ...
            button5.Location = new Point(4, 505);
            button5.Margin = new Padding(4, 5, 4, 5);
            button5.Name = "button5";
            button5.Size = new Size(754, 115);
            button5.TabIndex = 4;
            button5.Text = "라자냐";
            ...
            button6.Location = new Point(4, 630);
            button6.Margin = new Padding(4, 5, 4, 5);
            button6.Name = "button6";
            button6.Size = new Size(754, 118);
            button6.TabIndex = 5;
            button6.Text = "햄버거";
            ...
            button8.Location = new Point(651, 55);
            ...
            button9.Location = new Point(651, 7);
